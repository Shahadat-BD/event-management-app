        ...
        <div className='banner-added'>
            <div className='flex justify-center items-center lg:h-[600px] h-[350px]'>
                ...
                <button 
                   data-aos="zoom-in"
                   data-aos-easing="ease-out-cubic"
                   data-aos-duration="1000" className='text-white bg-orange-500 lg:px-12 lg:py-4 px-4 py-2  lg:mt-10 mt-5 font-bold lg:text-lg text-md items-center '>Explore Now <AiOutlineArrowRight className='float-right lg:mt-[3px] mt-1  lg:text-2xl'/> </button>
                </div>
            </div>
        </div>
    );
